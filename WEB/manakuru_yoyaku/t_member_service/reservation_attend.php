...
<?php
    ...
    $_SESSION['store_id_new']=$_POST['store_id_new'];
    $_SESSION['service_id_new']=$_POST['service_id_new'];
    $_SESSION['service_name_new']=$_POST['service_name_new'];
    $_SESSION['service_title_new']=$_POST['service_title_new'];
    $_SESSION['member_id_new']=$_POST['member_id_new'];
    $_SESSION['service_start_id_new']=$_POST['service_start_id_new'];
